...
namespace DIPSky.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have DIPSky 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<DipSkyObjectContext>(tablesToValidate, customCommands.ToArray());
