...
namespace DIPSky.Services.Orders
{
    ...
    public partial interface IOrderReportService
    {
        ...
        OrderAverageReportLine GetOrderAverageReportLine(int storeId, int vendorId, OrderStatus? os,
            ...
            DateTime? endTimeUtc, string billingEmail,  string employeeid,bool ignoreCancelledOrders = false);
        ...
        decimal ProfitReport(int storeId, int vendorId, 
            ...
            DateTime? startTimeUtc, DateTime? endTimeUtc, string billingEmail, string employeeid);
    }
}
