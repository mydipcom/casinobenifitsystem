...
namespace DIPSky.Services.Orders
{
    ...
    public partial class OrderReportService : IOrderReportService
    {
        ...
        public virtual OrderAverageReportLine GetOrderAverageReportLine(int storeId, int vendorId, OrderStatus? os,
            ...
            string billingEmail, string employeeid , bool ignoreCancelledOrders = false)
        {
            ...
            if (!String.IsNullOrEmpty(employeeid))
                query = query.Where(o => o.Customer.Username.Contains(employeeid)); 
        ...
        public virtual OrderAverageReportLineSummary OrderAverageReport(int storeId, OrderStatus os)
        {
            ...
            if (!timeZone.IsInvalidTime(t1))
            {
                ...
                var todayResult = GetOrderAverageReportLine(storeId, 0, os, null,null, startTime1, endTime1,null, null);
            ...
            if (!timeZone.IsInvalidTime(t2))
            {
                ...
                var weekResult = GetOrderAverageReportLine(storeId, 0, os, null, null, startTime2, endTime2, null, null);
            ...
            if (!timeZone.IsInvalidTime(t3))
            {
                ...
                var monthResult = GetOrderAverageReportLine(storeId, 0, os, null, null, startTime3, endTime3, null, null);
            ...
            if (!timeZone.IsInvalidTime(t4))
            {
                ...
                var yearResult = GetOrderAverageReportLine(storeId, 0, os, null, null, startTime4, endTime4, null, null);
            ...
            var allTimeResult = GetOrderAverageReportLine(storeId, 0, os, null, null, startTime5, endTime5, null, null);
        ...
        public virtual decimal ProfitReport(int storeId, int vendorId, 
            ...
            string billingEmail, string employeeid)
        {
            int? orderStatusId = null;
            if (os.HasValue)
                orderStatusId = (int)os.Value;
            ...
            bool employee = String.IsNullOrEmpty(employeeid);
            ...
            var query = from orderItem in _orderItemRepository.Table
                ...
                where (storeId == 0 || storeId == o.StoreId) &&
                      ...
                      (employee ||
                       (o.Customer != null && !String.IsNullOrEmpty(o.Customer.Username) &&
                        o.Customer.Username.Contains(employeeid)))
                select orderItem;

            var productCost = Convert.ToDecimal(query.Sum(orderItem => (decimal?)orderItem.OriginalProductCost * orderItem.Quantity));

            var reportSummary = GetOrderAverageReportLine(storeId, vendorId, os, ps, ss, startTimeUtc, endTimeUtc, billingEmail, employeeid);
