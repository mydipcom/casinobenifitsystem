...
namespace DIPSky.Services.Shipping
{
    /// <summary>
    /// Shipping service
    /// </summary>
    public partial class ShippingService : IShippingService
    {
        ...
        /// {0} : warehouse ID
        /// </remarks>
        private const string WAREHOUSES_BY_ID_KEY = "DIPSky.warehouse.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string WAREHOUSES_PATTERN_KEY = "DIPSky.warehouse.";
            ...
            int storeId = 0)
        {
            ...
            if (shippingRateComputationMethods.Count == 0)
                throw new DipSkyException("Shipping rate computation method could not be loaded");
