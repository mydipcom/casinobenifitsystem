...
namespace DIPSky.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// </remarks>
        private const string CUSTOMERROLES_ALL_KEY = "DIPSky.customerrole.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : system name
        /// </remarks>
        private const string CUSTOMERROLES_BY_SYSTEMNAME_KEY = "DIPSky.customerrole.systemname-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERROLES_PATTERN_KEY = "DIPSky.customerrole.";
        ...
        public virtual void DeleteCustomer(Customer customer)
        {
            ...
            if (customer.IsSystemAccount)
                throw new DipSkyException(string.Format("System customer account ({0}) could not be deleted", customer.SystemName));
        ...
        public virtual Customer InsertGuestCustomer()
        {
            ...
            if (guestRole == null)
                throw new DipSkyException("'Guests' role could not be loaded");
        ...
        public virtual void DeleteCustomerRole(CustomerRole customerRole)
        {
            ...
            if (customerRole.IsSystemRole)
                throw new DipSkyException("System role could not be deleted");
