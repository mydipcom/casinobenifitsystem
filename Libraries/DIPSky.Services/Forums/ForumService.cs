...
namespace DIPSky.Services.Forums
{
    /// <summary>
    /// Forum service
    /// </summary>
    public partial class ForumService : IForumService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string FORUMGROUP_ALL_KEY = "DIPSky.forumgroup.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : forum group ID
        /// </remarks>
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "DIPSky.forum.allbyforumgroupid-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUMGROUP_PATTERN_KEY = "DIPSky.forumgroup.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUM_PATTERN_KEY = "DIPSky.forum.";
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (customerTo == null)
            {
                throw new DipSkyException("Recipient could not be loaded");
            }
