...
namespace DIPSky.Services.Catalog
{
    /// <summary>
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        /// {1} : page size
        /// </remarks>
        private const string PRODUCTATTRIBUTES_ALL_KEY = "DIPSky.productattribute.all-{0}-{1}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTATTRIBUTES_BY_ID_KEY = "DIPSky.productattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : product ID
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTES_ALL_KEY = "DIPSky.productvariantattribute.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTES_BY_ID_KEY = "DIPSky.productvariantattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : product variant attribute ID
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTEVALUES_ALL_KEY = "DIPSky.productvariantattributevalue.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTEVALUES_BY_ID_KEY = "DIPSky.productvariantattributevalue.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : product ID
        /// </remarks>
        private const string PRODUCTVARIANTATTRIBUTECOMBINATIONS_ALL_KEY = "DIPSky.productvariantattributecombination.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTATTRIBUTES_PATTERN_KEY = "DIPSky.productattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTVARIANTATTRIBUTES_PATTERN_KEY = "DIPSky.productvariantattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTVARIANTATTRIBUTEVALUES_PATTERN_KEY = "DIPSky.productvariantattributevalue.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTVARIANTATTRIBUTECOMBINATIONS_PATTERN_KEY = "DIPSky.productvariantattributecombination.";
