...
{
    /// <summary>
    /// A class that finds types needed by DIPSky by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether DIPSky should iterate assemblies in the app domain when loading DIPSky types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that DIPSky assemblies arn't investigated (e.g. by not including something like "^DIPSky|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the DIPSky factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into DIPSky.
        /// </returns>
