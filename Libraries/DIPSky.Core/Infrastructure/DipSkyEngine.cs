...
{
    public class DipSkyEngine : IEngine
    {
        #region Fields
		...
		public DipSkyEngine(EventBroker broker, ContainerConfigurer configurer)
		{
        ...
        private void InitializeContainer(ContainerConfigurer configurer, EventBroker broker, DipSkyConfig config)
        {
        ...
        public void Initialize(DipSkyConfig config)
        {
