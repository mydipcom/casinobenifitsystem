    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here http://www.DIPSky.com/boards/t/21356/multi-store-roadmap-lets-discuss-update-done.aspx?p=6#90196
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new DipSkyException("DIPSky needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        private bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into DIPSky, 
                ...
                //The issue is described here: http://www.DIPSky.com/boards/t/10969/DIPSky-20-plugin.aspx?p=4#51318
        ...
        public virtual bool IsSearchEngine(HttpContextBase context)
        {
            ...
            //more info: http://www.DIPSky.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            if (context == null)
                return false;
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["DIPSky.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["DIPSky.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["DIPSky.IsPOSTBeingDone"] = value;
            }
        }
    }
}
