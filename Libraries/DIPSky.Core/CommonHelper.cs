...
using System.Web;
using DIPSky.Core.ComponentModel;
...
namespace DIPSky.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new DipSkyException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new DipSkyException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
            if (value != null && !value.GetType().IsAssignableFrom(pi.PropertyType))
                value = To(value, pi.PropertyType);
            pi.SetValue(instance, value, new object[0]);
        }

        public static TypeConverter GetDIPSkyCustomTypeConverter(Type type)
        {
        ...
        public static object To(object value, Type destinationType, CultureInfo culture)
        {
            if (value != null)
            {
                ...
                TypeConverter destinationConverter = GetDIPSkyCustomTypeConverter(destinationType);
                TypeConverter sourceConverter = GetDIPSkyCustomTypeConverter(sourceType);
