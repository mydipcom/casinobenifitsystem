...
using DIPSky.Core.Html.CodeFormatter;

namespace DIPSky.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.DIPSky.com]my site[/url]
                // becomes: <a href="http://www.DIPSky.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.DIPSky.com[/url]
                // becomes: <a href="http://www.DIPSky.com">http://www.DIPSky.com</a>
