...
using DIPSky.Plugin.DiscountRules.HasAllProducts.Models;
...
namespace DIPSky.Plugin.DiscountRules.HasAllProducts.Controllers
{
    [AdminAuthorize]
    public class DiscountRulesHasAllProductsController : Controller
    {
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            return View("DIPSky.Plugin.DiscountRules.HasAllProducts.Views.DiscountRulesHasAllProducts.Configure", model);
        }
