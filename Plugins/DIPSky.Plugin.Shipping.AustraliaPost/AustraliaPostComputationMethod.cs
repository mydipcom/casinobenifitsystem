...
namespace DIPSky.Plugin.Shipping.AustraliaPost
{
    ...
    public class AustraliaPostComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
            ...
            int weight, int length, int width, int height, int quantity)
        {
            ...
            if (tmp.Length != 3)
            {
                throw new DipSkyException("Response is not valid.");
            }
            ...
            {
                throw new DipSkyException(err_msg);
            }
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Shipping.AustraliaPost.Controllers" }, { "area", null } };
        }
