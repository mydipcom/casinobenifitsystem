...
using DIPSky.Plugin.Payments.CheckMoneyOrder.Controllers;
...
namespace DIPSky.Plugin.Payments.CheckMoneyOrder
{
    /// <summary>
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Payments.CheckMoneyOrder.Controllers" }, { "area", null } };
        }
