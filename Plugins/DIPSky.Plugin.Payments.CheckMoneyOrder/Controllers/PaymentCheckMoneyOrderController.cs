...
using DIPSky.Core;
using DIPSky.Plugin.Payments.CheckMoneyOrder.Models;
...
namespace DIPSky.Plugin.Payments.CheckMoneyOrder.Controllers
{
    public class PaymentCheckMoneyOrderController : BaseDIPSkyPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Payments.CheckMoneyOrder.Views.PaymentCheckMoneyOrder.Configure", model);
        }
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("DIPSky.Plugin.Payments.CheckMoneyOrder.Views.PaymentCheckMoneyOrder.PaymentInfo", model);
        }
