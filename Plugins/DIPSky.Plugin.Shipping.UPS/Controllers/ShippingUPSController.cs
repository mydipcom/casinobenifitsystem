...
using DIPSky.Plugin.Shipping.UPS.Models;
using DIPSky.Services.Configuration;
using DIPSky.Web.Framework.Controllers;

namespace DIPSky.Plugin.Shipping.UPS.Controllers
{
    [AdminAuthorize]
    public class ShippingUPSController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Shipping.UPS.Views.ShippingUPS.Configure", model);
        }
