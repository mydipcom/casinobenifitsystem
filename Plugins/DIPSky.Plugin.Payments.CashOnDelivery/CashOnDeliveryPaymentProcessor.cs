...
using DIPSky.Plugin.Payments.CashOnDelivery.Controllers;
...
namespace DIPSky.Plugin.Payments.CashOnDelivery
{
    /// <summary>
    ...
    public class CashOnDeliveryPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Payments.CashOnDelivery.Controllers" }, { "area", null } };
        }
