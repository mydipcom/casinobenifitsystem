...
using DIPSky.Core;
using DIPSky.Plugin.Payments.CashOnDelivery.Models;
...
namespace DIPSky.Plugin.Payments.CashOnDelivery.Controllers
{
    public class PaymentCashOnDeliveryController : BaseDIPSkyPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Payments.CashOnDelivery.Views.PaymentCashOnDelivery.Configure", model);
        }
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("DIPSky.Plugin.Payments.CashOnDelivery.Views.PaymentCashOnDelivery.PaymentInfo", model);
        }
