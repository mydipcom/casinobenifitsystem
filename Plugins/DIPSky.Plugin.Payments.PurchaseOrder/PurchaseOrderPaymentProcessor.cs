...
using DIPSky.Plugin.Payments.PurchaseOrder.Controllers;
...
namespace DIPSky.Plugin.Payments.PurchaseOrder
{
    ...
    public class PurchaseOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Payments.PurchaseOrder.Controllers" }, { "area", null } };
        }
