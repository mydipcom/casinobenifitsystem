...
using DIPSky.Plugin.Payments.PayPalStandard.Controllers;
...
namespace DIPSky.Plugin.Payments.PayPalStandard
{
    ...
    public class PayPalStandardPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            if (_paypalStandardPaymentSettings.PassProductNamesAndTotals)
            {
                ...
                if (cartTotal > postProcessPaymentRequest.Order.OrderTotal)
                {
                    ...
                    //gift card or rewared point amount applied to cart in DIPSky - shows in Paypal as "discount"
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Payments.PayPalStandard.Controllers" }, { "area", null } };
        }
