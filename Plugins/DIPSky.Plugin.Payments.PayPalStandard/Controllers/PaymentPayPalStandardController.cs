...
using DIPSky.Plugin.Payments.PayPalStandard.Models;
...
namespace DIPSky.Plugin.Payments.PayPalStandard.Controllers
{
    public class PaymentPayPalStandardController : BaseDIPSkyPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Payments.PayPalStandard.Views.PaymentPayPalStandard.Configure", model);
        }
        ...
        {
            return View("DIPSky.Plugin.Payments.PayPalStandard.Views.PaymentPayPalStandard.PaymentInfo");
        }
        ...
        public ActionResult PDTHandler(FormCollection form)
        {
            ...
            if (processor == null ||
                ...
                throw new DipSkyException("PayPal Standard module cannot be loaded");
