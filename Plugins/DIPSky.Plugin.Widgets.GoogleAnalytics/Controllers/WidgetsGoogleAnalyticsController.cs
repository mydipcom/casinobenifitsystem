...
using DIPSky.Plugin.Widgets.GoogleAnalytics.Models;
...
namespace DIPSky.Plugin.Widgets.GoogleAnalytics.Controllers
{
    public class WidgetsGoogleAnalyticsController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Widgets.GoogleAnalytics.Views.WidgetsGoogleAnalytics.Configure", model);
        }
        ...
        public ActionResult PublicInfo(string widgetZone)
        {
            ...
            //return View("DIPSky.Plugin.Widgets.GoogleAnalytics.Views.WidgetsGoogleAnalytics.PublicInfo", model);
        }
