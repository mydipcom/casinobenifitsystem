...
using DIPSky.Plugin.Shipping.USPS.Models;
using DIPSky.Services.Configuration;
using DIPSky.Web.Framework.Controllers;

namespace DIPSky.Plugin.Shipping.USPS.Controllers
{
    [AdminAuthorize]
    public class ShippingUSPSController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Shipping.USPS.Views.ShippingUSPS.Configure", model);
        }
