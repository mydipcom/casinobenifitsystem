...
using DIPSky.Plugin.ExternalAuth.Facebook.Models;
...
namespace DIPSky.Plugin.ExternalAuth.Facebook.Controllers
{
    public class ExternalAuthFacebookController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.ExternalAuth.Facebook.Views.ExternalAuthFacebook.Configure", model);
        }
        ...
        {
            return View("DIPSky.Plugin.ExternalAuth.Facebook.Views.ExternalAuthFacebook.PublicInfo");
        }
        ...
        private ActionResult LoginInternal(string returnUrl, bool verifyResponse)
        {
            ...
            if (processor == null ||
                ...
                throw new DipSkyException("Facebook module cannot be loaded");
