...
using DIPSky.Plugin.SMS.Verizon;
using DIPSky.Plugin.Sms.Verizon.Models;
using DIPSky.Services.Configuration;
using DIPSky.Services.Localization;
using DIPSky.Web.Framework.Controllers;

namespace DIPSky.Plugin.Sms.Verizon.Controllers
{
    [AdminAuthorize]
    public class SmsVerizonController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.SMS.Verizon.Views.SmsVerizon.Configure", model);
        }
