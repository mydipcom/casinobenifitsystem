...
using DIPSky.Plugin.Shipping.FixedRateShipping.Models;
...
namespace DIPSky.Plugin.Shipping.FixedRateShipping.Controllers
{
    [AdminAuthorize]
    public class ShippingFixedRateController : Controller
    {
        ...
        {
            return View("DIPSky.Plugin.Shipping.FixedRateShipping.Views.ShippingFixedRate.Configure");
        }
