...
public partial class TrackService : System.Web.Services.Protocols.SoapHttpClientProtocol
{
    ...
    private System.Threading.SendOrPostCallback getTrackNotificatioDIPSkyerationCompleted;
    ...
    {
        if ((this.getTrackNotificatioDIPSkyerationCompleted == null))
        {
            this.getTrackNotificatioDIPSkyerationCompleted = new System.Threading.SendOrPostCallback(this.OngetTrackNotificatioDIPSkyerationCompleted);
        }
        this.InvokeAsync("getTrackNotification", new object[] {
                    TrackNotificationRequest}, this.getTrackNotificatioDIPSkyerationCompleted, userState);
    }

    private void OngetTrackNotificatioDIPSkyerationCompleted(object arg)
    {
