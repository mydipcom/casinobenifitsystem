...
using DIPSky.Plugin.Shipping.Fedex.Domain;
using DIPSky.Plugin.Shipping.Fedex.RateServiceWebReference;
...
using DIPSky.Services.Shipping.Tracking;

namespace DIPSky.Plugin.Shipping.Fedex
{
    /// <summary>
    ...
    public class FedexComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        private RateRequest CreateRateRequest(GetShippingOptionRequest getShippingOptionRequest, out Currency requestedShipmentCurrency)
        {
            ...
            request.TransactionDetail.CustomerTransactionId = "***Rate Available Services v7 Request - DIPSky***"; // This is a reference field for the customer.  Any value can be used and will be provided in the response.
        ...
        private void SetShipmentDetails(RateRequest request, GetShippingOptionRequest getShippingOptionRequest, decimal orderSubTotal, string currencyCode)
        {
            ...
            //More info: http://www.DIPSky.com/boards/t/27348/fedex-rate-can-be-excessive-for-express-methods-if-calculated-on-a-saturday.aspx
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (IsPackageTooLarge(dimension, dimension, dimension))
                        throw new DipSkyException("fedexSettings.PackingPackageVolume exceeds max package size");
        ...
        private MeasureWeight GetUsedMeasureWeight()
        {
            ...
            if (usedMeasureWeight == null)
                throw new DipSkyException("FedEx shipping service. Could not load \"{0}\" measure weight", MEASUREWEIGHTSYSTEMKEYWORD);
        ...
        private MeasureDimension GetUsedMeasureDimension()
        {
            ...
            if (usedMeasureDimension == null)
                throw new DipSkyException("FedEx shipping service. Could not load \"{0}\" measure dimension", MEASUREDIMENSIONSYSTEMKEYWORD);
        ...
        private Currency GetRequestedShipmentCurrency(string originCountryCode, string destinCountryCode)
        {
            ...
            //because DIPSky does not have a concept of a designated currency for a Country.
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Shipping.Fedex.Controllers" }, { "area", null } };
        }
        ...
        public override void Install()
        {
            ...
            var settings = new FedexSettings()
            {
                ...
                DropoffType = DIPSky.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter,
            ...
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.PackingType.PackByDimensions", "Pack by dimensions");
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.PackingType.PackByOneItemPerPackage", "Pack by one item per package");
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.PackingType.PackByVolume", "Pack by volume");
            ...
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter", "Business service center");
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.DropBox", "Drop box");
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.RegularPickup", "Regular pickup");
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.RequestCourier", "Request courier");
            this.AddOrUpdatePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.Station", "Station");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.PackingType.PackByDimensions");
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.PackingType.PackByOneItemPerPackage");
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.PackingType.PackByVolume");
            ...
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter");
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.DropBox");
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.RegularPickup");
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.RequestCourier");
            this.DeletePluginLocaleResource("Enums.DIPSky.Plugin.Shipping.Fedex.DropoffType.Station");
