...
using DIPSky.Plugin.Shipping.Fedex.Models;
using DIPSky.Services.Configuration;
using DIPSky.Web.Framework;
using DIPSky.Web.Framework.Controllers;

namespace DIPSky.Plugin.Shipping.Fedex.Controllers
{
    [AdminAuthorize]
    public class ShippingFedexController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Shipping.Fedex.Views.ShippingFedex.Configure", model);
        }
