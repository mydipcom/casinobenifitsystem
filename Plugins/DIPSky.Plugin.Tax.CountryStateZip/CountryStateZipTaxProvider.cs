...
using DIPSky.Plugin.Tax.CountryStateZip.Infrastructure.Cache;
...
namespace DIPSky.Plugin.Tax.CountryStateZip
{
    ...
    public class CountryStateZipTaxProvider : BasePlugin, ITaxProvider
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Tax.CountryStateZip.Controllers" }, { "area", null } };
        }
