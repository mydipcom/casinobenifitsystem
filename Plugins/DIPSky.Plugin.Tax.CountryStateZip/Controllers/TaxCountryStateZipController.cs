...
using DIPSky.Plugin.Tax.CountryStateZip.Models;
...
namespace DIPSky.Plugin.Tax.CountryStateZip.Controllers
{
    [AdminAuthorize]
    public class TaxCountryStateZipController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Tax.CountryStateZip.Views.TaxCountryStateZip.Configure", model);
        }
