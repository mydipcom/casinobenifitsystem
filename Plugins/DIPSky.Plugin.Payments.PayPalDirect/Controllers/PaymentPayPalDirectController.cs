...
using DIPSky.Plugin.Payments.PayPalDirect.Models;
using DIPSky.Plugin.Payments.PayPalDirect.Validators;
...
namespace DIPSky.Plugin.Payments.PayPalDirect.Controllers
{
    public class PaymentPayPalDirectController : BaseDIPSkyPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Payments.PayPalDirect.Views.PaymentPayPalDirect.Configure", model);
        }
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("DIPSky.Plugin.Payments.PayPalDirect.Views.PaymentPayPalDirect.PaymentInfo", model);
        }
        ...
        public ActionResult IPNHandler()
        {
            ...
            if (processor == null ||
                ...
                throw new DipSkyException("PayPal Direct module cannot be loaded");
                    ...
                    case "recurring_payment":
                        #region Recurring payment
                        {
                            ...
                            if (initialOrder != null)
                            {
                                ...
                                _logger.Information("PayPal IPN. Recurring info", new DipSkyException(sb.ToString()));
                            }
                            else
                            {
                                _logger.Error("PayPal IPN. Order is not found", new DipSkyException(sb.ToString()));
                            }
                        }
                        #endregion
                        break;
            ...
            {
                _logger.Error("PayPal IPN failed.", new DipSkyException(strRequest));
            }
