...
using DIPSky.Plugin.Payments.PayPalDirect.Controllers;
using DIPSky.Plugin.Payments.PayPalDirect.PayPalSvc;
...
namespace DIPSky.Plugin.Payments.PayPalDirect
{
    ...
    public class PayPalDirectPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        protected CreditCardTypeType GetPaypalCreditCardType(string creditCardType)
        {
            ...
            //throw new DIPSkyException("Unknown credit card type");
        }
        ...
        protected ProcessPaymentResult AuthorizeOrSale(ProcessPaymentRequest processPaymentRequest, bool authorizeOnly)
        {
            ...
            details.PaymentDetails.ButtonSource = "DIPSkyCart";
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Payments.PayPalDirect.Controllers" }, { "area", null } };
        }
