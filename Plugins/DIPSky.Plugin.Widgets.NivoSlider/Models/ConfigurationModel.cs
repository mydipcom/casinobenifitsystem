...
namespace DIPSky.Plugin.Widgets.NivoSlider.Models
{
    public class ConfigurationModel : BaseDIPSkyModel
    {
        ...
        [DipSkyResourceDisplayName("Plugins.Widgets.NivoSlider.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [DipSkyResourceDisplayName("Plugins.Widgets.NivoSlider.Text")]
        [AllowHtml]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [DipSkyResourceDisplayName("Plugins.Widgets.NivoSlider.Link")]
        [AllowHtml]
