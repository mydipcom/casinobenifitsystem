...
using DIPSky.Plugin.Widgets.NivoSlider.Infrastructure.Cache;
using DIPSky.Plugin.Widgets.NivoSlider.Models;
...
namespace DIPSky.Plugin.Widgets.NivoSlider.Controllers
{
    public class WidgetsNivoSliderController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Widgets.NivoSlider.Views.WidgetsNivoSlider.Configure", model);
        }
        ...
        public ActionResult PublicInfo(string widgetZone)
        {
            ...
            return View("DIPSky.Plugin.Widgets.NivoSlider.Views.WidgetsNivoSlider.PublicInfo", model);
        }
    }
}