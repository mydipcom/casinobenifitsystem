...
using DIPSky.Plugin.Shipping.ByWeight.Models;
...
namespace DIPSky.Plugin.Shipping.ByWeight.Controllers
{
    [AdminAuthorize]
    public class ShippingByWeightController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Shipping.ByWeight.Views.ShippingByWeight.Configure", model);
        }
        ...
        public ActionResult AddPopup()
        {
            ...
            return View("DIPSky.Plugin.Shipping.ByWeight.Views.ShippingByWeight.AddPopup", model);
        }
        [HttpPost]
        ...
        public ActionResult EditPopup(int id)
        {
            ...
            return View("DIPSky.Plugin.Shipping.ByWeight.Views.ShippingByWeight.EditPopup", model);
        }
        [HttpPost]
