...
using DIPSky.Plugin.Feed.Froogle.Models;
...
namespace DIPSky.Plugin.Feed.Froogle.Controllers
{
    [AdminAuthorize]
    public class FeedFroogleController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Feed.Froogle.Views.FeedFroogle.Configure", model);
        }
