...
using DIPSky.Core;
using DIPSky.Plugin.Payments.Manual.Models;
using DIPSky.Plugin.Payments.Manual.Validators;
...
namespace DIPSky.Plugin.Payments.Manual.Controllers
{
    public class PaymentManualController : BaseDIPSkyPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Payments.Manual.Views.PaymentManual.Configure", model);
        }
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("DIPSky.Plugin.Payments.Manual.Views.PaymentManual.PaymentInfo", model);
        }
