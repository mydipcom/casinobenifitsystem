...
using DIPSky.Plugin.Payments.Manual.Controllers;
...
namespace DIPSky.Plugin.Payments.Manual
{
    /// <summary>
    ...
    public class ManualPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Payments.Manual.Controllers" }, { "area", null } };
        }
