...
using DIPSky.Plugin.Payments.AuthorizeNet.Controllers;
using DIPSky.Plugin.Payments.AuthorizeNet.net.authorize.api;
...
namespace DIPSky.Plugin.Payments.AuthorizeNet
{
    /// <summary>
    ...
    public class AuthorizeNetPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public ProcessPaymentResult ProcessPayment(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            if (_authorizeNetPaymentSettings.TransactMode == TransactMode.Authorize)
                ...
                throw new DipSkyException("Not supported transaction mode");
            ...
            if (!processPaymentRequest.IsRecurringPayment)
            {
                ...
                switch (processPaymentRequest.RecurringCyclePeriod)
                {
                    ...
                    case RecurringProductCyclePeriod.Years:
                        ...
                        break;
                    default:
                        throw new DipSkyException("Not supported cycle period");
                }
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "DIPSky.Plugin.Payments.AuthorizeNet.Controllers" }, { "area", null } };
        }
