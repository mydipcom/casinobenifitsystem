...
using DIPSky.Core;
using DIPSky.Plugin.Payments.AuthorizeNet.Models;
using DIPSky.Plugin.Payments.AuthorizeNet.Validators;
...
namespace DIPSky.Plugin.Payments.AuthorizeNet.Controllers
{
    public class PaymentAuthorizeNetController : BaseDIPSkyPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("DIPSky.Plugin.Payments.AuthorizeNet.Views.PaymentAuthorizeNet.Configure", model);
        }
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("DIPSky.Plugin.Payments.AuthorizeNet.Views.PaymentAuthorizeNet.PaymentInfo", model);
        }
