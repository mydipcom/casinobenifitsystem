...
namespace DIPSky.Admin
{
    public static class HtmlExtensions
    {
        public static MvcHtmlString DIPSkyField<TModel>(this HtmlHelper<TModel> helper, 
            System.Linq.Expressions.Expression<Func<TModel, string>> expression)
        {
            return helper.DIPSkyCommonField(expression, (x => helper.TextBoxFor(x)));
        }

        private static MvcHtmlString DIPSkyCommonField<TModel, TValue>(this HtmlHelper<TModel> helper, 
            ...
            Func<System.Linq.Expressions.Expression<Func<TModel, TValue>>,MvcHtmlString> editor)
        {
            ...
            sb.Append(helper.DIPSkyLabelFor(expression).ToHtmlString() + ":");
