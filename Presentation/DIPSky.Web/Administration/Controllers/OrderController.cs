...
{
	[AdminAuthorize]
	public partial class OrderController : BaseDIPSkyController
    {
        #region Fields
		...
		public ActionResult OrderList(GridCommand command, OrderListModel model)
        {
            ...
            var orders = _orderService.SearchOrders(model.StoreId, model.VendorId, 0, 0, 0,
                ...
                paymentStatus, shippingStatus, model.CustomerEmail,model.EmployeeId, model.OrderGuid,
            ...
            var gridModel = new GridModel<OrderModel>
            {
                Data = orders.Select(x =>
                {
                    ...
                    return new OrderModel()
                    {
                        ...
                        EmployeeId = x.Customer.Username, 
            ...
            var reportSummary = _orderReportService.GetOrderAverageReportLine(model.StoreId,
                ...
                startDateValue, endDateValue, model.CustomerEmail, model.EmployeeId);
        ...
        public ActionResult PartiallyRefundOrderPopup(string btnId, string formId, int id, bool online, OrderModel model)
        {
            ...
            try
            {
                ...
                if (amountToRefund <= decimal.Zero)
                    throw new DipSkyException("Enter amount to refund");
        ...
        public ActionResult AddShipment(int orderId, FormCollection form, bool continueEditing)
        {
            ...
            {
                ErrorNotification(_localizationService.GetResource("Admin.Orders.Shipments.DIPSkyroductsSelected"));
        ...
        protected virtual IList<OrderIncompleteReportLineModel> GetOrderIncompleteReportModel()
        {
            ...
            //not paid
            var psPending = _orderReportService.GetOrderAverageReportLine(0, 0, null, PaymentStatus.Pending, null, null, null, null,null, true);
            ...
            //not shipped
            var ssPending = _orderReportService.GetOrderAverageReportLine(0, 0, null, null, ShippingStatus.NotYetShipped, null, null, null, null, true);
            model.Add(new OrderIncompleteReportLineModel()
            {
            ...
            //pending
            var osPending = _orderReportService.GetOrderAverageReportLine(0, 0, OrderStatus.Pending, null, null, null, null, null, null, true);
            model.Add(new OrderIncompleteReportLineModel()
            {
            ...
            //Cancelled
            var osCancelled = _orderReportService.GetOrderAverageReportLine(0, 0, OrderStatus.Cancelled, null, null, null, null, null, null, true);
            model.Add(new OrderIncompleteReportLineModel()
            {
                Item = _localizationService.GetResource("Admin.SalesReport.Incomplete.TotalCancelledOrders"),
                Count = osCancelled.CountOrders,
                Total = _priceFormatter.FormatPrice(osCancelled.SumOrders, true, false)
            });
            //osProcessing
            var osProcessing = _orderReportService.GetOrderAverageReportLine(0, 0, OrderStatus.Processing, null, null, null, null, null, null, true);
            model.Add(new OrderIncompleteReportLineModel()
            {
                Item = _localizationService.GetResource("Admin.SalesReport.Incomplete.TotalProcessingOrders"),
                Count = osProcessing.CountOrders,
                Total = _priceFormatter.FormatPrice(osProcessing.SumOrders, true, false)
            });
            return model;
        }
        [ChildActionOnly]
