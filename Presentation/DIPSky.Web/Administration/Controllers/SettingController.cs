...
{
	[AdminAuthorize]
    public partial class SettingController : BaseDIPSkyController
	{
		#region Fields
        ...
        public ActionResult ChangeEncryptionKey(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                ...
                if (String.IsNullOrEmpty(newEncryptionPrivateKey) || newEncryptionPrivateKey.Length != 16)
                    throw new DipSkyException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TooShort"));

                string oldEncryptionPrivateKey = securitySettings.EncryptionKey;
                if (oldEncryptionPrivateKey == newEncryptionPrivateKey)
                    throw new DipSkyException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TheSame"));
        ...
        public ActionResult ToggleFullText(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                if (! _fulltextService.IsFullTextSupported())
                    throw new DipSkyException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.FullTextSettings.NotSupported"));
