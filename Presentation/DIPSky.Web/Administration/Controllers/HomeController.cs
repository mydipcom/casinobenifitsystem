...
using System.Xml;
using DIPSky.Admin.Infrastructure.Cache;
using DIPSky.Admin.Models.Home;
using DIPSky.Core;
...
namespace DIPSky.Admin.Controllers
{
    ...
    public partial class HomeController : BaseDIPSkyController
    {
        ...
        [ChildActionOnly]
        public ActionResult DIPSkyNews()
        {
            try
            {
                string feedUrl = string.Format("http://www.DIPSky.com/NewsRSS.aspx?Version={0}&Localhost={1}&HideAdvertisements={2}&StoreURL={3}",
                    DipSkyVersion.CurrentVersion, 
        ...
        [HttpPost]
        public ActionResult DIPSkyNewsHideAdv()
        {
