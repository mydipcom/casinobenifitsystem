...
{
    [AdminAuthorize]
    public partial class CurrencyController :  BaseDIPSkyController
    {
        #region Fields
            ...
            if (liveRates)
            {
                try
                {
                    ...
                    if (primaryExchangeCurrency == null)
                        throw new DipSkyException("Primary exchange rate currency is not set");
        ...
        public ActionResult Delete(int id)
        {
            ...
            try
            {
                if (currency.Id == _currencySettings.PrimaryStoreCurrencyId)
                    throw new DipSkyException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeletePrimary"));

                if (currency.Id == _currencySettings.PrimaryExchangeRateCurrencyId)
                    throw new DipSkyException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeleteExchange"));
