...
{
    public partial class ProductListModel : BaseDIPSkyModel
    {
        ...
        [DipSkyResourceDisplayName("Admin.Catalog.Products.List.SearchIncludeSubCategories")]
        ...
        [DipSkyResourceDisplayName("Admin.Catalog.Products.List.SearchWarehouse")]
        public int SearchWarehouseId { get; set; }
        [DipSkyResourceDisplayName("Admin.Catalog.Products.List.SearchProductType")]
        public int SearchProductTypeId { get; set; }

        [DipSkyResourceDisplayName("Admin.Catalog.Products.List.GoDirectlyToSku")]
        [AllowHtml]
