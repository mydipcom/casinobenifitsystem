...
using DIPSky.Web.Models.News;

namespace DIPSky.Web.Controllers
{
    [DipSkyHttpsRequirement(SslRequirement.No)]
    public partial class NewsController : BaseDIPSkyController
    {
		#region Fields
        ...
        public ActionResult NewsCommentAdd(int newsItemId, NewsItemModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["DIPSky.news.addcomment.result"] = _localizationService.GetResource("News.Comments.SuccessfullyAdded");
