...
using DIPSky.Web.Models.Blogs;

namespace DIPSky.Web.Controllers
{
    [DipSkyHttpsRequirement(SslRequirement.No)]
    public partial class BlogController : BaseDIPSkyController
    {
		#region Fields
        ...
        public ActionResult BlogCommentAdd(int blogPostId, BlogPostModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["DIPSky.blog.addcomment.result"] = _localizationService.GetResource("Blog.Comments.SuccessfullyAdded");
