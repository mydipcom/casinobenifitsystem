...
namespace DIPSky.Web.Controllers
{
    ...
    public partial class BoardsController : BaseDIPSkyController
    {
        #region Fields
            ...
            string within, string limitDays, int page = 1)
        {
            ...
            try
            {
                if (String.IsNullOrWhiteSpace(searchterms) == false)
                {
                    ...
                    {
                        throw new DipSkyException(string.Format(_localizationService.GetResource("Forum.SearchTermMinimumLengthIsNCharacters"),
