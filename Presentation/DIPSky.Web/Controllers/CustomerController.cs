...
using DIPSky.Web.Framework.UI.Captcha;
...
{
    public partial class CustomerController : BaseDIPSkyController
    {
        #region Fields
        ...
        public ActionResult Register(RegisterModel model, string returnUrl, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var registrationRequest = new CustomerRegistrationRequest(customer, model.Email,
                    _customerSettings.UsernamesEnabled ? model.Username : model.Email, model.Password, model.Phone, _customerSettings.DefaultPasswordFormat, isApproved);
                ...
                if (registrationResult.Success)
                {
                    ...
                    if (_customerSettings.NotifyNewCustomerRegistration)
                    {
                        ...
                        string Message = "We welcome you to " + _storeContext.CurrentStore.Name + ".";//_localizationService.GetResource("Checkout.TermsOfService.Read");
        ...
        public ActionResult AddressAdd()
        {
            ...
            model.Address.PrepareModel(null, false, _addressSettings, _localizationService,
                    _stateProvinceService, () => _countryService.GetAllCountries());
            model.Address.Email = _workContext.CurrentCustomer.Email;
            return View(model);
        }
                ...
                try
                {
                    ...
                    if ((uploadedFile != null) && (!String.IsNullOrEmpty(uploadedFile.FileName)))
                    {
                        ...
                        if (uploadedFile.ContentLength > avatarMaxSize)
                            throw new DipSkyException(string.Format(_localizationService.GetResource("Account.Avatar.MaximumUploadedFileSize"), avatarMaxSize));
