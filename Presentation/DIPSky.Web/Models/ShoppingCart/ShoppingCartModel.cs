...
namespace DIPSky.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseDIPSkyModel
    {
        ...
        public partial class CheckoutAttributeModel : BaseDIPSkyEntityModel
        {
        ...
        public partial class CheckoutAttributeValueModel : BaseDIPSkyEntityModel
        {
            public string Name { get; set; }
        ...
        public partial class DiscountBoxModel: BaseDIPSkyModel
        {
        ...
        public partial class GiftCardBoxModel : BaseDIPSkyModel
        {
            public bool Display { get; set; }
            public string Message { get; set; }
        }

        public partial class OrderReviewDataModel : BaseDIPSkyModel
        {
