...
namespace DIPSky.Web.Models.Customer
{
    ...
    public partial class RegisterModel : BaseDIPSkyModel
    {
        ...
        [DipSkyResourceDisplayName("Account.Fields.Password")]
        [AllowHtml]
        public string Password { get; set; }

        [DataType(DataType.Password)]
        [DipSkyResourceDisplayName("Account.Fields.ConfirmPassword")]
        [AllowHtml]
