...
{
    public partial class SubmitReturnRequestModel : BaseDIPSkyModel
    {
        ...
        [AllowHtml]
        [DipSkyResourceDisplayName("ReturnRequests.ReturnReason")]
        public string ReturnReason { get; set; }
        public IList<SelectListItem> AvailableReturnReasons { get; set; }

        [AllowHtml]
        [DipSkyResourceDisplayName("ReturnRequests.ReturnAction")]
        public string ReturnAction { get; set; }
        public IList<SelectListItem> AvailableReturnActions { get; set; }

        [AllowHtml]
        [DipSkyResourceDisplayName("ReturnRequests.Comments")]
