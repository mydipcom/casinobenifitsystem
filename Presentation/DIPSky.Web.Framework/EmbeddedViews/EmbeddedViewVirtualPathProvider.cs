...
namespace DIPSky.Web.Framework.EmbeddedViews
{
    public class EmbeddedViewVirtualPathProvider : VirtualPathProvider
    {
        ...
        private bool IsEmbeddedView(string virtualPath)
        {
            ...
            for example: both DIPSky.Plugin.Plugin1 and DIPSky.Plugin.Plugin2 can have Views\Config\Configure.cshtml files
