...
namespace DIPSky.Web.Framework.Security
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, Inherited = true, AllowMultiple = false)]
    public class DipSkyHttpsRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public DipSkyHttpsRequirementAttribute(SslRequirement sslRequirement)
        {
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            switch (this.SslRequirement)
            {
                ...
                case SslRequirement.NoMatter:
                    ...
                    break;
                default:
                    throw new DipSkyException("Not supported SslProtected parameter");
            }
        }
