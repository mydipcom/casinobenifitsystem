...
namespace DIPSky.Web.Framework.Themes
{
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public ThemeProvider(DipSkyConfig dipSkyConfig, IWebHelper webHelper)
        {
            basePath = webHelper.MapPath(dipSkyConfig.ThemeBasePath);
            LoadConfigurations();
        }
