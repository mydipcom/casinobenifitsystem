...
namespace DIPSky.Services.Tests.Seo
{
    [TestFixture]
    public class SeoExtensionsTests
    {
        ...
        {
            SeoExtensions.GetSeName("abcdefghijklmDIPSkyqrstuvwxyz1234567890", false, false).ShouldEqual("abcdefghijklmDIPSkyqrstuvwxyz1234567890");
        }
